...
function editarSeccion(seccion) {
    const campos = seccion === 'datos'
        ? ['perfil-nombre', 'perfil-apellido', 'perfil-celular', 'perfil-dni', 'perfil-fecha', 'perfil-provincia', 'perfil-localidad']
        : ['dir-calle', 'dir-numero', 'dir-piso', 'dir-depto', 'dir-provincia', 'dir-localidad', 'dir-cp', 'dir-referencias'];
...
function cancelarEdicion(seccion) {
    if (seccion === 'datos') {
        document.getElementById('perfil-nombre').value = nombreOriginal;
        document.getElementById('perfil-apellido').value = apellidoOriginal;
        document.getElementById('perfil-celular').value = datosOriginales.celular || '';
        document.getElementById('perfil-dni').value = datosOriginales.dni || '';
        document.getElementById('perfil-fecha').value = datosOriginales.fechaNacimiento || '';
        document.getElementById('perfil-provincia').value = datosOriginales.provincia || '';
        document.getElementById('perfil-localidad').value = datosOriginales.localidad || '';

        ['perfil-nombre', 'perfil-apellido', 'perfil-celular', 'perfil-dni', 'perfil-fecha', 'perfil-provincia', 'perfil-localidad'].forEach(id => {
            document.getElementById(id).disabled = true;
        });
    } else {
        document.getElementById('dir-calle').value = direccionOriginal.calle || '';
        document.getElementById('dir-numero').value = direccionOriginal.numero || '';
        ...
        document.getElementById('dir-provincia').value = direccionOriginal.dirProvincia || '';
        document.getElementById('dir-localidad').value = direccionOriginal.dirLocalidad || '';
        document.getElementById('dir-cp').value = direccionOriginal.codigoPostal || '';
        document.getElementById('dir-referencias').value = direccionOriginal.referencias || '';

        ['dir-calle', 'dir-numero', 'dir-piso', 'dir-depto', 'dir-provincia', 'dir-localidad', 'dir-cp', 'dir-referencias'].forEach(id => {
            document.getElementById(id).disabled = true;
        });
    }
