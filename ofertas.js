...
function agregarAlCarrito(nombre, precio, btn) {
    const wrap = btn.closest('.producto-acciones').querySelector('.cantidad-wrap span');
...
window.addEventListener('load', function() {
    ...
    if (cartWrap && panel) {
        ...
        cartWrap.addEventListener('mouseleave', function(e) {
        ...
        panel.addEventListener('mouseleave', function(e) {
            if (!cartWrap.contains(e.relatedTarget)) {
                panel.classList.remove('activo');
            }
        });
    }
